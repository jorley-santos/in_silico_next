**Pipeline Improvements - Incoming**

- Add parameter to control output folder

- Add parameters to control abundance and coverage distributions

- Include Singularity and Conda containers 
